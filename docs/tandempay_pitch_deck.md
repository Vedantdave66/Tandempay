...
## 💡 The Solution — TandemPay

**TandemPay** is a modern, full-stack fintech web application that lets users **track shared expenses, automatically simplify group debts, and settle up** — all in a stunning, premium dark-mode interface.

**Live App:** [https://tandempay.ca](https://tandempay.ca)
...
- Example: If Alice owes Bob $20, Bob owes Charlie $20 → TandemPay simplifies it to: **Alice pays Charlie $20** (1 payment instead of 2).

### 3. Settlement Tracking & Payment Flow
- **"Settle Up" modal** shows exactly how much you owe and to whom.
- Supports two payment methods:
  - **In-App Wallet** — pay directly from your TandemPay wallet balance.
...
- **Add funds** to your TandemPay wallet from linked bank accounts.
...
- Plaid Link UI handles all the bank authentication — TandemPay never sees your bank credentials.
...
- **User search** — find other TandemPay users by name or email with live suggestions.
...
- **Render Blueprint** ([render.yaml](file:///c:/Users/vedan/.gemini/antigravity/playground/TandemPay/render.yaml)) for one-click deployment:
  - `tandempay-api` — Python web service (Gunicorn + Uvicorn workers)
  - `tandempay-web` — Static site (React build served via CDN)
  - `tandempay-db` — Managed PostgreSQL database
...
| Feature | TandemPay | Splitwise | Venmo |
|---------|-----------|-----------|-------|
| Free to use | ✅ | ❌ (Premium $) | ✅ |
...
**GitHub:** [github.com/Vedantdave66/Tandempay](https://github.com/Vedantdave66/Tandempay)
**Live Demo:** [tandempay.ca](https://tandempay.ca)
