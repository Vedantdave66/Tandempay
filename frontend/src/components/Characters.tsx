...
const MAX_PHRASES = ["Welcome back! 🎉", "Ready to split?", "Let's get it!", "Your squad awaits!"];
const RUE_PHRASES = ["Oh, you're back.", "Remembered your password this time?", "Finally.", "Sure, come on in."];
const KAI_PHRASES = ["So happy to see you! 🥰", "We missed you!", "Yay you're here!", "Come on in 💚"];
const ZO_PHRASES  = ["hey.", "sup.", "cool.", "...hi."];
...
const TAIL_BORDER: CSSProperties = {
...
export default function Characters({
  ...
  const [currentPhrase, setCurrentPhrase] = useState(MAX_PHRASES[0]);
  ...
  useEffect(() => {
    const phrases: Record<Speaker, string[]> = {
      max: MAX_PHRASES, zo: ZO_PHRASES,
      rue: RUE_PHRASES, kai: KAI_PHRASES,
    };
