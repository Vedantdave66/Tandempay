...
export default function ForgotPasswordPage() {
    ...
    return (
        ...
        >
            {!submitted ? (
                <>
                    <div className="mb-6 auth-field" style={{ animationDelay: '200ms' }}>
                    ...
                    {error && (
                        <div className="mb-6 p-4 bg-danger/10 border border-danger/20 rounded-xl auth-field" style={{ animationDelay: '200ms' }}>
                ...
                <div className="text-center py-4 auth-field" style={{ animationDelay: '100ms' }}>
