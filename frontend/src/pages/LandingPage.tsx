...
import { Wallet, Shield, Zap, TrendingUp, Users, ArrowRight, PlayCircle, Bell, UserPlus, CheckCircle2, Crown } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-bg text-primary selection:bg-accent/30 selection:text-white overflow-hidden transition-colors duration-500">
            ...
            <main className="relative z-10 pt-32">
                    ...
                    <div className="flex-1 text-center lg:text-left z-10">
                        ...
                        <Reveal delay={100}>
                            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-primary tracking-tight mb-8 leading-[1.1]">
                                Split expenses.<br />
                                <span className="text-primary">Settle instantly.</span>
                            </h1>
                        </Reveal>
                        ...
                        <Reveal delay={300}>
                            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                                <Link to="/register" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-accent to-emerald-500 hover:from-accent-hover hover:to-emerald-600 text-white font-bold transition-transform transform hover:scale-[1.02] active:scale-[0.98] shadow-lg flex items-center justify-center gap-2">
                                    Create Free Account
                    ...
                    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <Reveal delay={200}>
                            ...
                            <p className="text-lg text-secondary leading-relaxed mb-6">
                                Create an expense in seconds. Whether you're splitting a simple cab ride equally, or itemizing a complex grocery receipt, TandemPay handles the math so you don't have to.
                            </p>
                ...
                <section className="py-24 border-t border-border relative overflow-hidden bg-surface-light">
                    ...
                    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
                        <Reveal delay={200} className="order-2 md:order-1">
                            ...
                            <p className="text-lg text-secondary leading-relaxed mb-6">
                                Inside a group, debt can get messy. A owes B, B owes C, C owes A. TandemPay's algorithm automatically optimizes these debts behind the scenes.
                            </p>
                            ...
                            <div className="bg-surface border border-border rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                                <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
                                    <div className="space-y-8">
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-secondary">Pay with Apple Pay, Google Pay, or Card directly powered by Stripe without leaving TandemPay.</p>
                                            </div>
                                        </div>
                                        <div className="flex gap-4">
                                            <div className="w-10 h-10 rounded-xl bg-primary/5 flex items-center justify-center shrink-0 border border-border">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                <h3 className="text-primary font-bold mb-1">Interac Friendly</h3>
                                                <p className="text-sm text-secondary">TandemPay calculates exactly who owes what. You execute the e-Transfer in your own bank app — we handle all the math.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-bg border border-border rounded-2xl p-6 shadow-xl relative animate-float-slow">
                                        ...
                                        <button className="w-full py-3 rounded-xl bg-accent text-white font-bold shadow-md hover:shadow-lg transition-shadow">
                                            Pay Balance Now
                                        </button>
                                    </div>
                                </div>
                ...
                {/* Pro Section */}
                <section className="py-20 border-t border-b border-border bg-surface-light">
                    <Reveal>
                        <div className="max-w-3xl mx-auto px-6 text-center">
                            <Crown className="w-10 h-10 text-amber-500 mx-auto mb-6" />
                            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">
                                Do more with TandemPay Pro
                            </h2>
                            <p className="text-lg text-secondary max-w-xl mx-auto mb-8">
                                Unlock receipt scanning, recurring expense automation, CSV exports,
                                and Interac auto-confirmation — starting at $4.99/month.
                            </p>
                            <Link
                                to="/pricing"
                                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-amber-500 hover:bg-amber-400 text-white font-bold transition-colors shadow-lg"
                            >
                                See Pro features
                                <ArrowRight className="w-5 h-5" />
                            </Link>
